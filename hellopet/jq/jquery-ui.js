...
function Datepicker() {
	...
	this._defaults = { // Global defaults for all the date picker instances
		...
		yearRange: "c-1:c+0", // Range of years to display in drop-down,
